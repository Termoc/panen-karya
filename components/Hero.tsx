  ...
  return (
    <main className="relative w-full h-screen overflow-hidden m-0 flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center max-h-200 max-w-200 text-white text-center px-4">
        ...
        <button className="text-2xl bg-[#43A047] pr-9 pl-9 pt-3 pb-3 rounded-2xl m-4 hover:rounded-3xl hover:bg-[#367938] ease-in-out duration-300 group relative overflow-hidden">
          <Link href="/olahan" className="flex items-center justify-center">
